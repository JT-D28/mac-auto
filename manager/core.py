...
class BusinessDataEncoder(XJsonEncoder):
	def __init__(self, **args):
		super(BusinessDataEncoder, self).__init__(
			['id', 'businessname', 'db_check', 'itf_check', 'params', 'postposition', 'preposition', 'count'], **args)
...
class TemplateEncoder(XJsonEncoder):
	def __init__(self, **args):
		super(DBEncoder, self).__init__(['id', 'kind', 'name', 'description', 'author', 'createtime', 'updatetime'],
		                                **args)

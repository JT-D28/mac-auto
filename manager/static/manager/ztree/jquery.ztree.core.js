...
(function ($) {
  var settings = {}, roots = {}, caches = {},
    ...
    data = {
      ...
      getNodeTextIcon:function(setting,node){
    ...
    view = {
      addNodes: function (setting, parentNode, index, newNodes, isSilent) {
        ...
        if (parentNode) {
          ...
          if (!parentNode.open) {
            ...
            if(!data.getNodeTextIcon(setting,parentNode)){
      ...
      appendNodes: function (setting, level, nodes, parentNode, index, initFlag, openFlag) {
        ...
        for (var i = 0, l = nodes.length; i < l; i++) {
          ...
          if (openFlag) {
            //console.log("【appendNodes】openFlag="+openFlag)
      ...
      expandCollapseParentNode: function (setting, node, expandFlag, animateFlag, callback) {
        //console.log('expandCollapseParentNodel')
        if (!node) return;
        if (!node.parentTId) {
      ...
      expandCollapseSonNode: function (setting, node, expandFlag, animateFlag, callback) {
        //console.log('expandCollapseSonNode')
        var root = data.getRoot(setting),
      ...
      makeDOMNodeIcon: function (html, setting, node) {
        ...
        isTextIcon=data.getNodeTextIcon(setting,node),
        textIcon=isTextIcon?isTextIcon:view.makeNodeIcoClass(setting,node),
      ...
      replaceMyClass:function(node, obj, newName) {
        // body...
        // console.log('[设定class] ')
        // console.log(obj)
        // console.log(newName)
         obj.attr("class", newName);
      },
